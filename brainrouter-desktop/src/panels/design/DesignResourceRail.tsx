...
export function DesignResourceRail({ activeResource, onResourceChange, entries, selected, onSelect, elements, selectedRef, onLayerSelect }: {
  ...
  return <aside className="ds-resource-rail" aria-label="Design resources">
    ...
    <div className="ds-resource-content">
      ...
      {activeResource === 'components' && <ComponentList elements={componentElements(elements)} selectedRef={selectedRef} onSelect={onLayerSelect} />}
